        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted-foreground mb-8">
              By accessing and using Resonance, you accept and agree to be bound by the terms and
            ...
            <p className="text-muted-foreground mb-4">
              Permission is granted to temporarily access the applications on Resonance for personal,
            ...
            <ul className="list-disc pl-6 text-muted-foreground mb-8 space-y-2">
              ...
              <li>Attempt to reverse engineer any software contained on Resonance</li>
            ...
            <p className="text-muted-foreground mb-8">
              ...
              content, you grant Resonance a worldwide, non-exclusive, royalty-free license to use,
            ...
            <p className="text-muted-foreground mb-8">
              The materials on Resonance are provided on an 'as is' basis. Resonance makes no
            ...
            <p className="text-muted-foreground mb-8">
              In no event shall Resonance or its suppliers be liable for any damages (including, without
              limitation, damages for loss of data or profit, or due to business interruption) arising out of
              the use or inability to use the materials on Resonance.
            </p>

            <h2 className="text-3xl font-heading font-bold mb-4">6. Revisions</h2>
            <p className="text-muted-foreground mb-8">
              The materials appearing on Resonance could include technical, typographical, or photographic
              errors. Resonance does not warrant that any of the materials on its website are accurate,
              complete, or current. Resonance may make changes to the materials contained on its website
